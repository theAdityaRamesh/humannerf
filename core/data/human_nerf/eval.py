...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        '''
        1. do novel view synthesis for all camera poses from 1-23
        2. have obtained the frame_name we want to do NVS for
        3 . Have to user a for loop to get the initial camera poses
            from all the camera_1->camera_23, not just the training view.
        '''
        # bgcolor from adventure.yaml
        ...
        '''# bgcolor, and smpl info will be same for all camera poses
        '''
        # check that a camera exists for the specified frame.
        # in the cameras.pkl file
        assert frame_name in self.cameras
        '''
        1. here K & E will have to be a list of K matrices instead of a single camera matrix
            corresponding to only the 1st training view.
        '''
        ...
        '''
        1. Here we will apply the apply_global_tfm_to_camera function 23 times for all
            the camera views.
        '''
        ...
        T = E[:3, 3]
        '''
        1. here we will get the rays from a list of k,r,t matrices 23 times.
        2. so rays_o and rays_d will be a list of 23 camera pose infos corresponding to
            the various camera1->camera23.
        '''
